...
- This app is built so that crucial concepts are learned

- user authentication using devise

- users can track stocks, up to 10 per each user. The profile page will display all the current stock prices
